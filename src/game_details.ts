...
export const gameDetails: Game[] = [
  ...
  },
  {
    ...
    details: ['RPG', 'Sandbox', 'Hack+slash', 'Thirdperson'],
    meta: [
      'Fox',
      'Magic',
      'Souls-like',
  ...
  },
  {
    ...
    details: ['Behind-Overhead Perspective', 'ARPG', 'Hack+slash'],
    meta: [
      'Souls-like',
      'Exploration',
      'Combat',
    ...
    other: ['Dark Fantasy', 'Magic', 'Souls-like'],
    processed: true,
    refined: false,
    freeReveal: '',
  },
